...
describe('TextDisplay Component', () => {
  ...
  it('applies fixedTypographyStyles typography styles from the theme', () => {
    ...
    expect(textComponent.props.style[3].fontFamily).toBe(mockTheme.typography.display.fontFamily);
    expect(textComponent.props.style[3].fontSize).toBe(mockTheme.typography.display.fontSize);
    expect(textComponent.props.style[3].lineHeight).toBe(mockTheme.typography.display.lineHeight);
  });
